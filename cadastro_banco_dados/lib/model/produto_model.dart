class ProdutoModel {
  ...
  Map<String, dynamic> toMap() {
    return {
      if (id != null) 'id': id, // Inclui o ID se não for nulo
      'nome': nome,
      ...
      'ativo': ativo
          ? 1
          : 0, // SQLite não tem tipo booleano, usamos 1 para true e 0 para false
      'em_promocao': emPromocao ? 1 : 0, // Mesmo caso para emPromocao
      'desconto': desconto,
    };
  }
  ...
  factory ProdutoModel.fromMap(Map<String, dynamic> map) {
    return ProdutoModel(
      ...
      imagem: map['imagem'],
      ativo: (map['ativo'] ?? 0) == 1, // Converte 1/0 para booleano
      emPromocao: (map['em_promocao'] ?? 0) == 1, // Converte 1/0 para booleano
